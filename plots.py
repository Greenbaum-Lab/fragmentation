...
plt.plot(rand['step'], rand['avg'], label="avg rand", color="blue")
plt.plot(rand['step'], rand['median'], label="med rand", color="blue", linestyle='dashed')
plt.plot(cor['step'], cor['avg'], label="avg cor", color="red")
plt.plot(cor['step'], cor['median'], label="med cor", color="red", linestyle='dashed')
plt.plot(dist['step'], dist['avg'], label="avg dist", color="green")
plt.plot(dist['step'], dist['median'], label="med dist", color="green", linestyle='dashed')
